...
import { ExhibitProperties, DataType } from 'src/app/services/api.generated.service';
...
import { boolSocket,} from '../rete-sockets';
...
export class ViewDeviceComponent extends Component implements AngularComponent {
    ...
    async addSensorConnectivity(node: Node, exhibit: ExhibitProperties, exhibitPathPrefix: boolean = false) {
